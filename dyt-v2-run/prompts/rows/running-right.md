Create one horizontal animation strip for Codex pet `dyt`, state `running-right`.
...
Identity: same pet in every frame: Preserve the existing cute chibi anime girl identity, long brown hair with white bow, blue cardigan, cream skirt, and white shoes.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
